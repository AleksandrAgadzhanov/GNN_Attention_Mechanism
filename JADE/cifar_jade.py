...
jobs = ["python GNN_framework/baselines.py --filename base_easy_SAT_jade",
        ...
        "python GNN_training/cross_validation.py --start_lambda 0.001 --end_lambda 0.005 --num 5",
...
# jobs = ["python GNN_framework/baselines.py --filename easy_base_easy_SAT_jade",
#         "python GNN_framework/baselines.py --filename base_easy_SAT_jade",
#         "python GNN_framework/baselines.py --filename val_SAT_jade"]
