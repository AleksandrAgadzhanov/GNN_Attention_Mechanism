...
# TODO change back to a single lambda function
def cross_validate_gnn(loss_lambdas, training_dataset_filename, validation_properties_filename, model_name,
...
def main():
    ...
    loss_lambdas = np.logspace(math.log10(0.1), math.log10(20), num=50)

    cross_validate_gnn(loss_lambdas, 'train_SAT_jade_dataset.pkl', 'val_SAT_jade.pkl', 'cifar_base_kw', 0.001, 25,
                       0.1, 100, 1, 20, 1, log_filename="cross_validation_log.txt", device='cuda')
