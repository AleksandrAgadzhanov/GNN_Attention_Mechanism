        ...
        for lay_idx in lay_to_iter:
            if acceleration_dict:
                if acceleration_dict['momentum'] and acceleration_dict['momentum'] != 0:
                    # use momentum
                    c_momentum = acceleration_dict['momentum'] * self.momentum[lay_idx] + (
                                1 / eta) * primal_vars.get_layer_subgradient(lay_idx)
                    ...
                    self.primal_grad[lay_idx] = self.rhos[lay_idx] - acceleration_dict['momentum'] * self.momentum[
                        lay_idx]
