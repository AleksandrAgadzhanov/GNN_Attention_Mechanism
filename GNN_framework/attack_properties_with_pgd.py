    ...
    for initialisation in range(num_initialisations):
        ...
        for attack_epoch in range(num_attack_epochs):
            ...
            for trial in range(num_trials):
                ...
                # TODO
                if num_attack_epochs == 2 and attack_epoch == 1 and trial == 14:
                    break

                if num_attack_epochs == 3 and attack_epoch == 2 and trial == 9:
                    break

                if num_attack_epochs == 4 and attack_epoch != 0 and trial == 7:
                    break

                if num_attack_epochs == 5 and attack_epoch == 4 and trial == 5:
                    break
...
def main():
    ...
    pgd_gnn_attack_properties(properties_filename, 'cifar_base_kw', 1.0, 0.1, 100, 4, 6, 3,
                              'experiment_results/GNN_4_zooms/gnn_parameters_4_zooms.pkl',
