...
def main():
    plot_training_loss('../experiment_results/cross_validation_training_losses/training_dict_0.04.pkl')
    # plot_cross_validation_results(directory='../experiment_results/GNN_2_zooms/cross_validation_1st_iteration/',
    #                               space='log')
