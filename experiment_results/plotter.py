...
def main():
    ...
    plot_cross_validation_results(directory='../experiment_results/GNN_5_zooms/cross_validation_2nd_iteration/',
                                  space='lin')
    # plot_attack_success_rates('GNN_4_zooms/gnn_4_zooms_dict_easy_test_dataset.pkl',
