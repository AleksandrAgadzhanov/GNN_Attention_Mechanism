...
def main():
    plot_training_loss('GNN_7_zooms/training_dict_7_zooms.pkl')
    # plot_cross_validation_results(directory='../experiment_results/GNN_7_zooms/cross_validation_2nd_iteration/',
    #                               space='lin')
