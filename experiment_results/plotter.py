...
def main():
    # plot_training_loss('../experiment_results/GNN_3_zooms/training_dict.pkl')
    plot_cross_validation_results(directory='../experiment_results/GNN_4_zooms/cross_validation_1st_iteration/',
                                  space='log')
